const accordionData = [
    ...
    {
        id: 2,
        title: "What are the synthetic events in React?",
    ...
    },
    {
        ...
        content: "Components are the building blocks of any React application, and a single app consists of multiple components. A component is essentially a piece of the user interface. It splits the user interface into independent, reusable parts that can be processed separately.",
    },
    {
        id: 4,
